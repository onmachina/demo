  ...
  return (
    <div className="w-2/4">
      <div className="drop-shadow-xl border border-red-400 bg-red-100 p-5 mb-5">
        ...
        <p>
          Are you sure you want to delete the container <strong>{containerName}</strong>? It contains {objectCount}{' '}
          objects totalling {formatFileSize(23000)} in data. This action cannot be undone.
        </p>
